...
public class Coruja extends Animais  {
    ...
    public void setRaca(String raca) {
        super.setRaca(raca); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public String getRaca() {
        return super.getRaca(); //To change body of generated methods, choose Tools | Templates.
    }
